  ...
  bindEvents(): void {
    this.el.addEventListener("click", (e: Event) => {
      ...
      if (btn && btn.dataset.audio) {
        const audio: HTMLAudioElement = new Audio(btn.dataset.audio);
        audio.play();
    ...
    return `
      <div class="vocabulary__header">
        <div class="vocabulary__sections">
          <a href="#" class="vocabulary__link" data-group="1">Группа&nbsp;1</a>
          <a href="#" class="vocabulary__link" data-group="2">Группа&nbsp;2</a>
          <a href="#" class="vocabulary__link" data-group="3">Группа&nbsp;3</a>
          <a href="#" class="vocabulary__link" data-group="4">Группа&nbsp;4</a>
          <a href="#" class="vocabulary__link" data-group="5">Группа&nbsp;5</a>
          <a href="#" class="vocabulary__link" data-group="6">Группа&nbsp;6</a>
        </div>
        <div>
      ...
      <div class="card">
        ...
        <div class="card__content">
            <div class="card__word">
                ...
                <button class="word__button" data-audio="https://rslang-app-2022.herokuapp.com/${
                  word.audio
                }">
  ...
  renderPagination(): string {
    return `
      <div class="pagination">
        ...
        <button class="button pagination__button-numbered">${this.page}</button>
